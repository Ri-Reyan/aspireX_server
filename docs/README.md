...
AspireX is a learning management system backend built with Node.js, Express.js, and MongoDB. It provides authentication and content management features for both users (students) and administrators.
...
- **Other**: Cookie Parser, Multer (for file uploads, though not fully implemented)
